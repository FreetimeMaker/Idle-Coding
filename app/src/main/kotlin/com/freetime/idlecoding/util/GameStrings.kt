 ...
 *
 * All user-visible game content names and descriptions live in strings.xml. JSON data files contain only internal snake_case
...
object GameStrings {
    ...
    fun skillEmoji(key: String): String = when (key) {
        "mining" -> "🐍"
        "fishing", "fletching", "ranged" -> "🌐"
        "farming" -> "🗃️"
        "woodcutting", "crafting", "magic" -> "💻"
        "firemaking", "smithing", "strength" -> "⚙️"
        "thieving" -> "⌨️"
        "combat", "boss", "slayer" -> "🐛"
        "mercantile" -> "💳"
        "carnival" -> "💡"
    ...
    /** Language glyphs replace the legacy fantasy artwork. */
    @Suppress("UNUSED_PARAMETER")
    fun skillIconRes(key: String): Int? = null
