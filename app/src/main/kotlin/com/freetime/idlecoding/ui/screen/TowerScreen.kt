...
import com.freetime.idlecoding.ui.viewmodel.TowerMilestone
import com.freetime.idlecoding.ui.viewmodel.TowerViewModel
    ...
    Card(
        ...
        Column(Modifier.padding(16.dp)) {
            ...
            if (availablePotions.isNotEmpty()) {
                Spacer(Modifier.height(12.dp))
                Text(
                    text  = stringResource(R.string.ui_potion),
                    style = MaterialTheme.typography.labelMedium,
                    color = MaterialTheme.colorScheme.onSurfaceVariant,
                )
                Spacer(Modifier.height(4.dp))
            ...
            if (BuildConfig.DEBUG) {
                TextButton(onClick = debugOnAdvance) {
                    Text(stringResource(R.string.ui_debug_advance_floor))
                }
            }
        }
    }
