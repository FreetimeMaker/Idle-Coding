...
import com.freetime.idlecoding.data.model.RecentSession
                ...
                Row(
                    ...
                    IconButton(
                        ...
                        Icon(
                            ...
                            contentDescription = stringResource(R.string.ui_remove_from_queue),
                            modifier           = Modifier.size(16.dp),
        ...
        Column(Modifier.padding(16.dp)) {
            ...
            FlowRow(
                ...
                if (BuildConfig.DEBUG && session != null && !isDone) {
                    TextButton(onClick = onDebugFinish) {
                        Text(stringResource(R.string.ui_debug_finish_worker))
                    }
                }
            }
        }
