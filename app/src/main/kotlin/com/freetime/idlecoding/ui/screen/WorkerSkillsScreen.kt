...
import com.freetime.idlecoding.data.model.WorkerTier
...
import com.freetime.idlecoding.ui.screen.skills.projectedXpLabel
import com.freetime.idlecoding.ui.viewmodel.CraftableRecipe
import com.freetime.idlecoding.ui.viewmodel.SheetState
import com.freetime.idlecoding.ui.viewmodel.WorkerSkillsUiState
import com.freetime.idlecoding.ui.viewmodel.WorkerSkillsViewModel
...
private fun WorkerCraftRecipeRow(
    ...
    Row(
        ...
        Column(horizontalAlignment = Alignment.End) {
            when {
                !meetsLvl  -> Text(
                    text  = stringResource(R.string.format_language_level, recipe.levelRequired),
                    style = MaterialTheme.typography.labelSmall,
                    color = dim,
                )
                canMake > 0 -> {
