        ...
        val boostLines = buildList {
            if (blessingActive) {
                ...
                val boostDesc = blessingData?.let { b ->
                    ...
                    when (b.type) {
                        BlessingType.XP      -> stringResource(R.string.format_boost_all_xp, ((eff * 100).roundToInt() / 100f).toString())
                        BlessingType.DEFENSE -> stringResource(R.string.format_boost_defense, eff.toInt())
                        BlessingType.COINS   -> stringResource(R.string.format_boost_coins, (eff * 100).roundToInt())
                    }
                }
